...
public class ItemConverter
    ...
    public ItemRest convert(Item obj, Projection projection) {
        ...
        item.setLastModifiedWithId(obj.getLastModified().toInstant().toEpochMilli() + "_" + obj.getID());
    ...
    public MetadataValueList getPermissionFilteredMetadata(Context context, Item obj, Projection projection) {
        List<MetadataValue> fullList = itemService.getMetadata(obj, Item.ANY, Item.ANY, Item.ANY, Item.ANY, projection.getEnableVirtualMetadata(), projection.getLanguage());
