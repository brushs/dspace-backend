 ...
 */
public class DataCiteDOIIdentifierProvider extends FilteredIdentifierProvider implements DOIIdentifierProvider {
    private static final Logger log = LoggerFactory.getLogger(DataCiteDOIIdentifierProvider.class);
     ...
     */
    protected DataCiteDOIIdentifierProvider() {
    }
    ...
    @Override
    public void processCallback(Context context, String batchId, String retrieveUrl) {
