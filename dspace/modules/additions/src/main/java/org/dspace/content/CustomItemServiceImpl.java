 ...
 */
public class CustomItemServiceImpl extends DSpaceObjectServiceImpl<Item> implements ItemService {
...
prevent the generation of resource policy entry values with null dspace_object as value
    ...
    */
    ...
    public List<MetadataValue> getMetadata(Item item, String schema, String element, String qualifier, String lang,
        ...
        return this.getMetadata(item, schema, element, qualifier, lang, enableVirtualMetadata, lang);
    }
